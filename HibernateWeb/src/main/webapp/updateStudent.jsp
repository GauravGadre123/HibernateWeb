...
<%@ page
	import="java.util.*,com.techno.dao.StudentDao,com.techno.entites.Student"%><!DOCTYPE html>
<html lang="en">
<head>
			...
			<form class="form-horizontal" action="updatestudent" method="post">
				<div class="card-body">
					<input type="hidden" class="form-control" name="sid"
						placeholder="Enter name" value="<%=st.getId()%>">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="number" class="form-control" name="stdmarks"
								placeholder="Enter marks" value="<%=st.getMarks()%>">
						</div>
					</div>
				</div>
